...
class ChannelRingEndToEndTest {
    ...
    // 2. End-to-end leg: second phone calls while XX-Dialer holds both roles —
    ...
    private companion object {
        ...
        const val ACTION_ANSWER = "com.piercingxx.xxdialer.probe.ANSWER"
        const val ACTION_DECLINE = "com.piercingxx.xxdialer.probe.DECLINE"
    }
}
