...
import com.piercingxx.xxphone.data.BackupJson
import com.piercingxx.xxphone.data.PatternRuleEntity
import com.piercingxx.xxphone.data.ScreenLogEntity
import com.piercingxx.xxphone.data.SettingsRepository
import com.piercingxx.xxphone.databinding.ActivityRulesBinding
import com.piercingxx.xxphone.databinding.ItemRuleRowBinding
import com.piercingxx.xxphone.databinding.ViewPatternBuilderBinding
import com.piercingxx.xxphone.databinding.ViewTestNumberSheetBinding
import com.piercingxx.xxphone.databinding.ViewWindowEditorBinding
import com.piercingxx.xxphone.ring.ChannelIds
import com.piercingxx.xxphone.ring.TileCountdown
import com.piercingxx.xxphone.telecom.FactSource
import com.piercingxx.xxphone.telecom.LogRows
import com.piercingxx.xxphone.util.BlocklistImport
...
class RulesActivity : AppCompatActivity() {
            ...
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                withContext(Dispatchers.Main) {
                    when {
                        ...
                        roleLost -> toast(
                            "blocked-number writes refused — XX-Phone must hold the dialer role (re-run Setup)",
                        )
    ...
    private companion object {
        ...
        const val BACKUP_FILE_NAME = "xx-phone-backup.json"
